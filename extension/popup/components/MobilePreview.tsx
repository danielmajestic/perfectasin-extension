      ...
      <div className="bg-white border border-gray-200 rounded-lg p-3">
        ...
        {isOverCap ? (
          <div className="mt-3 flex items-start gap-1.5 text-xs text-amber-600 bg-amber-50 p-2 rounded">
            ...
            <span>Title exceeds Amazon's 75-character cap — trim before July 27 or Amazon's AI will rewrite it</span>
          </div>
        ) : (
          <div className="mt-3 flex items-start gap-1.5 text-xs text-green-600 bg-green-50 p-2 rounded">
            <svg className="w-4 h-4 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <span>75-char compliant — displays fully on mobile.</span>
          </div>
        )}
      </div>
